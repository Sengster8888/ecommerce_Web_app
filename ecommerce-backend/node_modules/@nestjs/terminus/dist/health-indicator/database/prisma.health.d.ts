...
export declare class PrismaHealthIndicator {
     ...
     */
    pingCheck<Key extends string = string>(key: Key, prismaClient: PrismaClient, options?: PrismaClientPingCheckSettings): HealthCheckAttempt<Key>;
}
export {};
